...
plt.plot(sampled_steps, sampled_losses, label="Loss (Sampled)")

# 添加標題和標籤
plt.title("Training Loss vs Steps (Every 100 points)", fontsize=16)
...
output_path = os.path.join(current_dir, "trainer_state_every100.png")
